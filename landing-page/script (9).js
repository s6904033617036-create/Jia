/* ============================================================
   ...
   หมายเหตุโครงสร้างไฟล์ products.json ที่ใช้ (แก้ key ให้ตรงถ้าของจริงต่างจากนี้):
   [
     {
       "name": "Doggy Gang",
       "size": "20นิ้ว",
       "price": 553,
       "image": "images/doggy-gang.jpg",
       "pattern": "มังกร"   // ค่าที่เป็นไปได้: มังกร / ไม้เรื้อย / ตาราง / มจพ
     },
     ...
   ]
============================================================ */
...
function initProductPage() {
  ...
  function renderProducts() {
    ...
    const filtered =
      currentFilter === "ทั้งหมด"
        ? allProducts
        : allProducts.filter((p) => p.pattern === currentFilter);
